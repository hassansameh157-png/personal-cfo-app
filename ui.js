...
const UI = {
  ...
  catBar(name, v, max, kind, over, suffix) {
    ...
    return '<button class="bar-row" onclick="UI.viewCategoryTx(\'' + escJsArg(name) + "','" + escJsArg(kind) + '\')"><span class="bar-name">' + esc(name) + '</span>' +
